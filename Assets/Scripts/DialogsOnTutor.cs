...
public static class DialogsOnTutor
{
    ...
    public static void GenerateDialogs()
    {
        ...
        _queueDialogs.Enqueue(new Replica(11, "CAT",
            "О, нет! Зачем ты читал прочитал Заклинание из КНиги Разрушений! Я говорил о Лапке-Перчатке за стеклянной стеной! Ты рассыпал в пыль половину населения Вселенной!"));
