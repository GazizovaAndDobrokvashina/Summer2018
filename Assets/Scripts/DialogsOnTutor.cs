...
public static class DialogsOnTutor
{
    ...
    public static void GenerateDialogs()
    {
        ...
        _queueDialogs.Enqueue(new Replica(3, "FOX",
            "Это такая прозрачная фигня похожая на кость? Да не, не, не в коем случае..."));
        ...
        _queueDialogs.Enqueue(new Replica(6, "CAT",
            "Я уже слишком стар и не могу покинуть свою картину, беги по коридору дальше, там будет артефакт, способный повернуть время вспять..."));
        _queueDialogs.Enqueue(new Replica(7, "CAT", ""));
        _queueDialogs.Enqueue(new Replica(8, "FOX",
            "Заклинания на кошачьем? Гм, разберусь... Так что тут... О! вот тут написано \"Частички\"! Оно, должно быть собирает в единое целое частички!"));
        ...
        _queueDialogs.Enqueue(new Replica(11, "CAT",
            "О, нет! Зачем ты читал заклинания! Я говорил о Лапке-Перчатке за стеклянной стеной! Ты рассыпал в пыль половину населения Вселенной!"));
